...
use Controllers\Client\ClientDashBoardController;
use Controllers\Client\TerrainController;
use Controllers\Client\ClientStatsController;
...
Router::get('client/land-rentals', [TerrainController::class, 'currentRentals']);
