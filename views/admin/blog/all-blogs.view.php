...
<section class="main-banner">
    ...
    justify-content: space-between;">
                        <h3>Articles</h3>
                        <a class="edit" href="/admin/add-blog">Add New blog</a>
                        <a class="edit" href="/admin/add-category">Add Category</a>
                    </div>
                    <table style="overflow-x:auto;">
                      ...
                      foreach ($allBlogs as $value) {
                        ...
                        <td><a class="edit" href="/admin/edit-blog?id=<?=$value['id']?>">Edit</a>
                        <a class="edit" href="/admin/show-blog?id=<?=$value['id']?>">Show</a></th>
